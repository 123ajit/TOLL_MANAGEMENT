...
<hr>
		...
		${msg} 
			<br> Name:<input type="text" name="username" readonly="readonly" value="${adto.username}"><br>
			<br> Email:<input type="email" name="email" value="${adto.email}"><br>
			<br> Password:<input type="password" name="password" value="${adto.password}"><br>
			<br> Choose Toll:<select name="choosetoll" >
			<option value="Noida">${adto.choosetoll}</option>
				<option value="HauzKhas">HauzKhas</option>
				<option value="Saket">Saket</option>
				<option value="Noida">Noida</option>
				<option value="Gurgaon">Gurgaon</option>
			</select><br>
			<br> Role:<input type="text" name="role" value="${adto.role}"><br>
			<br> Expiry Date:<input type="text" name="expiryDate" readonly="readonly" value="${adto.expiryDate}"><br>
			<br> Status:<input type="radio" name="status" value="1"checked="checked"readonly="readonly">Active
