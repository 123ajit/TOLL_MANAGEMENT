...
public class UpdateController {
	...
	public ModelAndView updateAdminController(AdminDTO adminDTO, HttpServletRequest request) {
		...
		try {
			...
			adminDTO.setExpiryDate(dtoFromSession.getExpiryDate());
			 dtoFromDB = service.updateAdminService(adminDTO);
		...
		if(dtoFromDB.isRole()==true)
		{
			return new ModelAndView("SuperHome.jsp", "msg", "Details updated successfully");
		}
		else
		{
